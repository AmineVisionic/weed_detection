...
int main(int argc, char **argv)
{
  ...
  if (!n.hasParam("arm_camera_position_x"))
    ROS_WARN_STREAM("Used default parameter for arm_camera_position_x [0]");
  n.param("arm_camera_position_x", arm_camera_position_x, 0.0);

  double arm_camera_position_y;
  if (!n.hasParam("arm_camera_position_y"))
    ROS_WARN_STREAM("Used default parameter for arm_camera_position_y [0]");
  n.param("arm_camera_position_y", arm_camera_position_y, 0.0);
